...
from telecom.utilities.helper import list_keys_with_prefix
from telecom.utilities.redshift_utils_t import (
    run_sql_script, 
...
TABLE_CONFIGS = {
    "customers": {
        "schema": os.getenv('SDB_SCHEMA'),#"test_raw_schema",
